...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pdqtofs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pdqtofs.containers.anotherwebservice.com/
...
```
git clone git@github.com:Ninjago98765/container-pdqtofs.git
cd container-pdqtofs
```
...
```
docker attach container-pdqtofs
```
